...
if __name__ == "__main__":
    ...
    for k, (train_rids, test_rids) in enumerate(kf.split(all_rids)):
        ...
        # prediction targets
        dx_train, dx_test = y_t_train.loc['future_y_DX'], y_t_test.loc['future_y_DX']
        adas_train, adas_test = y_t_train.loc['future_y_ADAS11'], y_t_test.loc['future_y_ADAS11']
        ventricle_train, ventricle_test = y_t_train.loc['future_y_ADAS13'], y_t_test.loc['future_y_ADAS13']
